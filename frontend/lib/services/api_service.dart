  ...
  static Future<Map<String, dynamic>> register({
    ...
    try {
      ...
      if (userType == 'candidat') {
        allData['filiere'] = filiere;
        allData['age'] = age;
        allData['sexe'] = sexe;
        allData['domicile'] = domicile;
      } else {
        allData['nomSociete'] = nom;
        allData['domaine'] = domaine;
        allData['adresse'] = adresse;
        allData['villeLieu'] = villeLieu;
      }
      ...
      if (response.statusCode == 201) {
        ...
        try {
          ...
          if (bodyData is Map<String, dynamic> && bodyData['message'] != null) {
